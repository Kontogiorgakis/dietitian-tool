...
// Dark mode is an attribute in this app, see globals.css.
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-3 py-2 text-caption shadow-xl",
        className
      )}
    >
